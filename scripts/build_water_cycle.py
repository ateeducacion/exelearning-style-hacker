...
showcasing the Hacker theme. Run with python3.
...
def download_source_idevice(page_id: str, block_id: str, idv_id: str) -> str:
    inner_html = (
        ...
        '<tbody>'
        '<tr><th>Título</th><td>El ciclo del agua · Hacker</td></tr>'
        '<tr><th>Descripción</th><td>Unidad didáctica de ejemplo sobre el ciclo del agua, en estilo Hacker.</td></tr>'
        ...
        'style="background-color:#000000;color:#00ff9c;border:2px solid #00ff9c;font-family:\'JetBrains Mono\',monospace;">Descargar el archivo .elp</a></p>'
    )
    return (
        f'<odeComponent>'
        f'<odePageId>{page_id}</odePageId>'
...
REPO_URL = 'https://github.com/ateeducacion/exelearning-style-hacker'
GITHUB_PROXY_URL = 'https://github-proxy.exelearning.dev/?repo=ateeducacion/exelearning-style-hacker&amp;branch=main'
OPEN_IN_EXE_URL = f'https://static.exelearning.dev/?url={GITHUB_PROXY_URL}'
DOWNLOAD_STYLE_URL = f'{REPO_URL}/releases/latest/download/hacker.zip'
...
def action_buttons_html() -> str:
    ...
    <a href="{OPEN_IN_EXE_URL}" target="_blank" rel="noopener"
       style="display:inline-block;background:#000000;color:#00ff9c;padding:10px 18px;border:2px solid #00ff9c;box-shadow:0 0 12px rgba(0,255,156,0.45);font-family:'JetBrains Mono',monospace;font-size:16px;text-decoration:none;letter-spacing:0.5px;text-transform:uppercase;">
...
def illustration_html(idev_id: str, image_name: str, caption: str) -> str:
    ...
    return (
        ...
        f'style="max-width:320px;width:100%;height:auto;image-rendering:pixelated;border:2px solid #00ff9c;box-shadow:0 0 12px rgba(0,255,156,0.35);background:#000;" />'
        f'<figcaption style="font-family:\'JetBrains Mono\',monospace;font-size:13px;color:#00ff9c;margin-top:6px;letter-spacing:0.3px;">{h(caption)}</figcaption>'
        f'</figure>'
    )
...
def page_intro() -> str:
    ...
    two_col = (
        ...
        'alt="Paisaje del ciclo del agua en estilo Hacker" '
        'style="width:100%;max-width:240px;image-rendering:pixelated;border:2px solid #00ff9c;box-shadow:0 0 12px rgba(0,255,156,0.35);background:#000;display:block;" />'
        '</div>'
        ...
        '<p>El estilo visual está inspirado en las terminales hacker del cine: la <strong>lluvia digital de Matrix</strong>, los <strong>bordes neón de Tron</strong> y el panel lateral estilo <strong>PipBoy de Fallout</strong>. Abre el engranaje de la derecha (o pulsa <kbd>T</kbd>) para cambiar el acento neón (verde / ámbar / cian), activar scanlines, flicker o el marco curvo CRT, y reproducir la intro de arranque.</p>'
        '</div>'
        '</div>'
    )
...
def page_credits() -> str:
    ...
    intro = text_idevice(pid, bid, idv, 1, '',
        ...
        '''<p>Esta unidad de ejemplo ha sido creada por el <strong>Área de Tecnología Educativa</strong> de la Consejería de Educación, Formación Profesional, Actividad Física y Deportes del <strong>Gobierno de Canarias</strong>, para mostrar el estilo <em>Hacker</em> inspirado en <strong>Matrix · Tron · Fallout PipBoy</strong>.</p>
...
<ode>
<userPreferences><userPreference><key>theme</key><value>hacker</value></userPreference></userPreferences>
<odeResources>
...
<odeProperties>
  <odeProperty><key>pp_title</key><value>El ciclo del agua · Hacker</value></odeProperty>
  ...
  <odeProperty><key>pp_description</key><value>Unidad didáctica de ejemplo sobre el ciclo del agua, presentada con el estilo Hacker (Matrix · Tron · Fallout PipBoy).</value></odeProperty>
  <odeProperty><key>pp_theme</key><value>hacker</value></odeProperty>
...
images_src = '/Users/ernesto/Downloads/git/exelearning-style-hacker/imagenes-generadas'
